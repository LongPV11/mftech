...
export const AppBar: FC = (props) => {
  ...
  return (
    <div>
      {/* NavBar / Header */}
      <div className="flex flex-row shadow-lg navbar md:mb-2 bg-neutral text-neutral-content">
        <div className="navbar-start">
          <label
            htmlFor="my-drawer"
            className="flex md:hidden btn btn-square btn-ghost"
          >
            <svg
          ...
          <div className="hidden text-2xl sm:inline h-22 md:p-2">MFTECH</div>
        </div>
        ...
        <div className="navbar-end">
          <WalletMultiButton className="mr-4 btn btn-ghost" />
